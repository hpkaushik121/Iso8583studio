...
mk = bytes.fromhex("C9B406126D931ED05965C81E78F3D20B")
atc = bytes.fromhex("0003")
sk = derive_emv2000_tree_sk(mk, atc, 8, 4)
print(sk.hex().upper())
