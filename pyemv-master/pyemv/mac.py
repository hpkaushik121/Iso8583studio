...
def mac_iso9797_3(
    ...
    >>> key1 = bytes.fromhex("022551C4FDF76E45")
    >>> key2 = bytes.fromhex("988089BA31DC077C")
    >>> data = bytes.fromhex("3C00000103A4A0820000000010000000000000000710000000000007101302050030901B6A")
