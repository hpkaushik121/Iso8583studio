...
@Component({
  ...
  template: `<main class="doc-body">
        ...
        <ui-section anchor="current" heading="Current Release — v1.0.14">
            <div class="spec-list">
        ...
        <ui-section anchor="history" heading="Release History">
        ...
        <ui-section anchor="channel" heading="Release Channel">
            <ul>
