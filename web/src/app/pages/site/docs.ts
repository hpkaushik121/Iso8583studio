  ...
  template: `<main class="doc-body">
        ...
        <section class="doc-section" id="simulators">
            ...
            <div class="hub-grid">
                ...
                <a class="hub-card" href="/docs/hsm-simulator"><div class="hub-body"><div class="hub-title">HSM Simulator <span class="badge badge-teal">Available</span></div><p class="hub-desc">Thales payShield 10K emulation — host commands, LMK storage, keys, PIN and MAC.</p><span class="hub-link">Open guide →</span></div></a>
                <a class="hub-card" href="/docs/hsm-command-console"><div class="hub-body"><div class="hub-title">HSM Command Console <span class="badge badge-purple">Beta</span></div><p class="hub-desc">Host-command client for Thales, Futurex, Luna, Utimaco and nCipher — console, scenarios, load tests.</p><span class="hub-link">Open guide →</span></div></a>
                <a class="hub-card" href="/docs/pos-simulator"><div class="hub-body"><div class="hub-title">POS Simulator <span class="badge badge-teal">Available</span></div><p class="hub-desc">A configurable point-of-sale terminal — hardware, EMV &amp; contactless — driving ISO 8583 to a host.</p><span class="hub-link">Open guide →</span></div></a>
                <a class="hub-card" href="/docs/apdu-simulator"><div class="hub-body"><div class="hub-title">APDU Simulator <span class="badge badge-teal">Available</span></div><p class="hub-desc">EMV smart-card sessions — APDU exchange, TLV parsing, flow analysis and test plans.</p><span class="hub-link">Open guide →</span></div></a>
                <a class="hub-card" href="/docs/payment-switch"><div class="hub-body"><div class="hub-title">Switch Simulator <span class="badge badge-yellow">In development</span></div><p class="hub-desc">BIN routing, protocol translation and stand-in between acquirers and issuers.</p><span class="hub-link">Open guide →</span></div></a>
                <a class="hub-card" href="/docs/issuer-simulator"><div class="hub-body"><div class="hub-title">Issuer System <span class="badge badge-yellow">In development</span></div><p class="hub-desc">Issuer-side authorization — PIN and ARQC verification, limits, 0210 decisioning.</p><span class="hub-link">Open guide →</span></div></a>
        ...
        <section class="doc-section" id="tools">
            ...
            <div class="hub-grid">
                ...
                <a class="hub-card" href="/docs/cipher-tools"><div class="hub-body"><div class="hub-title">Cryptographic Tools <span class="badge badge-blue">7 tools</span></div><p class="hub-desc">AES, DES/3DES, RSA, Thales RSA, ECDSA and format-preserving encryption calculators.</p><span class="hub-link">Open reference →</span></div></a>
                <a class="hub-card" href="/docs/key-tools"><div class="hub-body"><div class="hub-title">Key Management <span class="badge badge-blue">10 tools</span></div><p class="hub-desc">DEA keys, key shares, SSL certificates, Atalla and Futurex key calculators.</p><span class="hub-link">Open reference →</span></div></a>
                <a class="hub-card" href="/docs/pin-tools"><div class="hub-body"><div class="hub-title">Payment Utilities <span class="badge badge-blue">21 tools</span></div><p class="hub-desc">PIN blocks (ISO 9564 and OEM), AES PIN blocks, TPK-to-ZPK translation and DUKPT PIN encryption.</p><span class="hub-link">Open reference →</span></div></a>
                <a class="hub-card" href="/docs/utility-tools"><div class="hub-body"><div class="hub-title">Data Converters <span class="badge badge-blue">6 tools</span></div><p class="hub-desc">Base64, Base94, BCD, character encoding, check digits and the Track 2 codec.</p><span class="hub-link">Open reference →</span></div></a>
                <a class="hub-card" href="/docs/dukpt-tools"><div class="hub-body"><div class="hub-title">DUKPT Tools</div><p class="hub-desc">Key derivation per ANSI X9.24 — IPEK, KSN walks and transaction keys.</p><span class="hub-link">Open reference →</span></div></a>
